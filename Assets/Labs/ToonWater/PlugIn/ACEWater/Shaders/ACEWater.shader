...
Shader "ACE/Water"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float amplitude7_g503 = _WaveHeight00;
			float steepness7_g503 = _WaveSteepness00;
			float4 param7_g503 = _WaveParam00;
			...
			float amplitude7_g504 = _WaveHeight01;
			float steepness7_g504 = _WaveSteepness01;
			float4 param7_g504 = _WaveParam01;
			...
			float amplitude7_g505 = _WaveHeight02;
			float steepness7_g505 = _WaveSteepness02;
			float4 param7_g505 = _WaveParam02;
			...
			#endif
			float3 temp_output_12_0_g513 = ( ( localGerstner7_g503 + localGerstner7_g504 + localGerstner7_g505 ) + staticSwitch514 + staticSwitch546 );
			float3 ase_vertexNormal = v.normal.xyz;
			float3 ase_vertexBitangent = cross( ase_vertexNormal, ase_vertexTangent) * v.tangent.w * unity_WorldTransformParams.w;
			v.vertex.xyz += ( ( ase_vertexTangent.xyz * (temp_output_12_0_g513).x ) + ( ase_vertexBitangent * (temp_output_12_0_g513).y ) + ( ase_vertexNormal * (temp_output_12_0_g513).z ) );
			#ifdef _GERSTNERGROUP1_ON
			...
			#endif
			float3 normalizeResult18 = normalize( ( ( normal7_g503 + normal7_g504 + normal7_g505 ) + staticSwitch515 + staticSwitch545 ) );
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 worldToViewDir3_g508 = mul( UNITY_MATRIX_V, float4( float3(0,1,0), 0 ) ).xyz;
			...
			#endif
			float3 normalizeResult135 = normalize( ( ( tangent7_g503 + tangent7_g504 + tangent7_g505 ) + staticSwitch516 + staticSwitch544 ) );
			#ifdef _GERSTNERGROUP1_ON
				float3 staticSwitch515 = ( normal7_g499 + normal7_g500 + normal7_g501 );
			#else
				float3 staticSwitch515 = _Vector1;
			...
			float3 worldToViewDir5_g508 = mul( UNITY_MATRIX_V, float4( objToWorldDir257, 0 ) ).xyz;
			float2 temp_output_12_0_g508 = ( min( ( _RefractionScale * clampDepth ) , _Refraction ) * ( (worldToViewDir3_g508).xz - (worldToViewDir5_g508).xz ) );
			float clampDepth9_g508 = Linear01Depth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, float4( ( (ase_screenPosNorm).xy + temp_output_12_0_g508 ), 0.0 , 0.0 ).xy ));
			float2 temp_output_276_0 = saturate( ( (ase_screenPosNorm).xy + ( ( step( clampDepth , clampDepth9_g508 ) * temp_output_12_0_g508 ) * saturate( ( ( clampDepth9_g508 - clampDepth ) * _RefractionDepthScale ) ) ) ) );
...
Node;AmplifyShaderEditor.FunctionNode;138;-5776,1712;Inherit;False;GerstnerWaveX3;-1;;502;da0432b290a00594e83efed3eeb65c75;0;9;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT4;0,0,0,0;False;9;FLOAT4;0,0,0,0;False;10;FLOAT4;0,0,0,0;False;3;FLOAT3;15;FLOAT3;0;FLOAT3;16
...
Node;AmplifyShaderEditor.FunctionNode;119;-5222.066,908.9139;Inherit;False;WaterUV;-1;;507;92d4681b6e0fd3e41a1a096df51a9c42;0;2;2;FLOAT2;1,0;False;8;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;126;-5222.066,588.9142;Inherit;False;WaterUV;-1;;506;92d4681b6e0fd3e41a1a096df51a9c42;0;2;2;FLOAT2;1,0;False;8;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;136;-3485.747,961.2318;Inherit;False;2;2;0;FLOAT3;1,0,0;False;1;FLOAT3x3;1,0,0,0,0,1,1,0,1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;276;-4203.593,-1473.274;Inherit;False;Refraction;44;;508;07e6eef5367028a4bbcf1b3d60556e23;0;1;1;FLOAT3;0,0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;448;-1238.602,-2210.514;Inherit;False;WaterUV;-1;;509;92d4681b6e0fd3e41a1a096df51a9c42;0;2;2;FLOAT2;1,0;False;8;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;450;-1238.602,-1890.515;Inherit;False;WaterUV;-1;;510;92d4681b6e0fd3e41a1a096df51a9c42;0;2;2;FLOAT2;1,0;False;8;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;60;-3502.125,-129.5614;Inherit;False;WaterUV;-1;;511;92d4681b6e0fd3e41a1a096df51a9c42;0;2;2;FLOAT2;1,0;False;8;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;59;-3502.125,-449.5612;Inherit;False;WaterUV;-1;;512;92d4681b6e0fd3e41a1a096df51a9c42;0;2;2;FLOAT2;1,0;False;8;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;89;-4397.586,1627.943;Inherit;False;GerstnerNormalize;-1;;513;65b5dbdc6530c4e4197f0726eb54b3fc;0;1;12;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=B1966D8688779896E73BBD8F2C2FC9B5F1A3B1E6