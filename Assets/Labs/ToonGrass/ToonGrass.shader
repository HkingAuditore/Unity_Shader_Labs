 ...
 Properties
    {
        ...
        [Header(Fur Setting)]
         ...
         _FurHeightTex ("Fur Height Tex", 2D) = "white" { }
         _FurShadeTex ("Fur Shade Tex", 2D) = "white" { }
        ...
        _FurHeightAdjust ("Fur Height Adjust", Float) = 0.5
        _FurHeightMin ("Fur Height Min", Float) = 0.1
        _FurHeightMax ("Fur Height Max", Float) = 1
